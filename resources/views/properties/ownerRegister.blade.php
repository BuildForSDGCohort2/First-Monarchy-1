    ...
    <body>
     ...
     <div class="container">
		...
		<div class="item4">
		 ...
		 <div class="item5">
		    <form id="login" class="loginform" method="POST" action="/register/owners" enctype="multipart/form-data">
          @csrf
      <div class ="formHeader">
          <h2>CREATE OWNER ACCOUNT</h2>
			 ...
			 <div>
				...
				<div class="input">
				     <label for="bio">Bio</label><textarea id="bio" type="text" class="textarea @error('bio') is-invalid @enderror"  value="{{ old('bio') }}" name="bio"  placeholder="Bio" required></textarea>
				</div>
                <div class="input">
    ...
    <label for="logo">Logo</label><input id="avatar" type="file" accept="image/*" name="logo" class="@error('avatar') is-invalid @enderror"  value="{{ old('logo') }}" required>
        ...
        <div class="input">
         ...
         @enderror
                     ...
                     <p>Already have an owner account ?<a class="crosslink" href="/login/owners">LOG IN</a>
			</form>
		 </div>
	 </div>
